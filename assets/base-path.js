/* assets/base-path.js
   Computes a stable base path for GitHub Pages project sites so every page
   (including /gallery/) fetches the same JSON: .../custom-clothing-site/data/products.json
*/
(function () {
